  ...
  const updateFetch = async () => {
    ...
    const headers = {
      ...
      headers: {
        ...
        Authorization:
          "Bearer " +
          "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2NGJhM2Q0M2VhYmUwNzAwMTQ2NGZiNGQiLCJpYXQiOjE2ODk5MjY5ODEsImV4cCI6MTY5MTEzNjU4MX0.Mz88uGOC-KnsgDV2rb3uhiZO3mALCbcXDXorp7fEMos",
      },
      body: JSON.stringify({
        name: name,
        surname: surname,
